...
using System.Linq;
using StockTickerImprovements.StockTickerSample.Model;
using XSockets.Core.XSocket;
using XSockets.Core.XSocket.Helpers;

namespace StockTickerImprovements.StockTickerSample.Controllers
{
    public class StockController : XSocketController
    {
        ...
        public StockController()
        {
            ...
            this.OnClientConnect += StockController_OnClientConnect;
        }

        void StockController_OnClientConnect(object sender, XSockets.Core.Common.Socket.Event.Arguments.OnClientConnectArgs e)
        {
